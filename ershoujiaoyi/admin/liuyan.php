...
<body>
	<div id="da"><img src="image/header.jpg"><a style="position:absolute;margin-left:-50px" href="#">登录</a></div>
	<div id="nav"><a href="index.html">返回首页</a><div id="nav1"><div id="wei"><div id="wei1"><p>请大家畅所欲言吧！</p></div><div id="wei2"><p>请大家畅所欲言吧！</p></div></div></div></div>
	<div id="zheng">
		<div id="aside">
			...
			<div id="nei1">
				...
				for($i=0;$i<$records;$i++){
				 ?>
			<p><strong style="color:red;font-family:宋体"><?php echo $q[$i][1] ?></strong>访问了你的空间</p>
			<?php } ?>
			</div>
			</div></div>
		</div>
	...
	return str;
			...
			<div id="ji"><p>留言板</p></div>
				...
				echo $res['tel']; -->
						...
						<?php }?>
						<!-- 获取留言时间 -->
										<h6 class="nini" style="margin-left:400px"><?php echo $p[$i]['time'] ?></h6>
										<!-- 获取赞数 -->
										<div class="ni4">
